...
SPIDER_MIDDLEWARES = {
    ...
    #'scrapy_splash.SplashAwareFSCacheStorage': 101,
    #'sample.middlewares.Iomv2SpiderMiddleware': 543,
}
...
# some settings to try for taobao
...
# DOWNLOADER_MIDDLEWARES = {
#    'sample.middlewares.Iomv2DownloaderMiddleware': 543,
# }
...
ITEM_PIPELINES = {
   #    'sample.pipelines.Iomv2Pipeline': 300,
    'scrapy.pipelines.images.ImagesPipeline': 1
}
# IMAGES_STORE = # <-- your s3 path
